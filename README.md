...
`${GOPATH}/github.com/nitzan-karni`
...
```
git remote set-url origin https://github.com/nitzan-karni/lsbeat
...
```
mkdir -p ${GOPATH}/github.com/nitzan-karni
cd ${GOPATH}/github.com/nitzan-karni
git clone https://github.com/nitzan-karni/lsbeat
```
